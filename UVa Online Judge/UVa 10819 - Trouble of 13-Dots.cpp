// UVa 10819 - Trouble of 13-Dots.cpp
...
const int SIZE = 10200 + 10;
int price[100 + 10], favor[100 + 10], dp[100 + 10][SIZE];


int F(int pos, int n, int b, int taken)
{
	if(taken > b && b < 1800)
		return -INF;
	...
	int ret1 = 0, ret2 = 0;
	ret1 = favor[pos] + F(pos + 1, n, b, price[pos] + taken);
	ret2 = F(pos + 1, n, b, taken);
