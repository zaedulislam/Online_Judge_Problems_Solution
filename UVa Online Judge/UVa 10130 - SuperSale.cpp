...
string S, T;
char s[SIZE];
int dp[SIZE][SIZE], price[SIZE], weight[SIZE], CAP, objects;
int M[1000][1000];

int superSale(int I, int w)
{
	if (I == objects + 1) return 0;
...
int main()
{
	...
	int tcases, caseno = 1, n, I, J, K, N, cnt = 0, len, people;
