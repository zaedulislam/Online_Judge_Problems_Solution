...
int ar[SIZE], parent[SIZE];
vector<int> vi, increasingSub;
...
void PrintLIS()
{
	...
	for (I = increasingSub.size() - 1; I >= 0; I--)
		PF("%d\n", increasingSub[I]);
}
...
{
	///BOOST
	int tcases, I, J, K, N, n, m, cnt = 0, len, lisLength;
	///READ();
	///WRITE();
	SET(parent);
