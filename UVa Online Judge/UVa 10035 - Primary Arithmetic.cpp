...
int main()
{
	...
	int tcases, caseno = 1, n, I, J, K, N, cnt, len, n1, n2, rem1, rem2, sum, carry;

    while(sf("%d%d",&n1, &n2) , n1 || n2){
        ...
        if(!cnt) pf("No carry operation.\n");
        else if(cnt == 1) pf("%d carry operation.\n",cnt);
        else pf("%d carry operations.\n",cnt);
    }
	return 0;
}
