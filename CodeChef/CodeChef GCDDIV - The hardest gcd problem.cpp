// CodeChef GCDDIV - The hardest gcd problem.cpp
...
void PrimeFactorize(int GCD, int K)
{
	int I, p, N = GCD, SZ, flag;
	for(p = 2; p * p <= N; p++)
	{
		if(N % p == 0)
		{
...
int main()
{
	...
	///READ();
	///WRITE();
	int T, I, J, K, N, n, m, k, cnt = 0, len, GCD;
