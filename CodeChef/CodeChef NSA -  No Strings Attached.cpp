// CodeChef NSA -  No Strings Attached.cpp
...
string S;
int before[SIZE][26 + 5], after[SIZE][26 + 5];
...
int main()
{
	...
	///READ();
	///WRITE();
	int T, I, J, K, N, n, m, k, cnt = 0, len, c1, c2;
    ...
    while(T--)
    {
        ...
        for(I = 1; I < len; I++)
        {
            ...
            {
                if(S[I - 1] < ch)
                    before[I][ch - 'a'] = before[I - 1][ch - 'a'] + 1;
                else
                    before[I][ch - 'a'] = before[I - 1][ch - 'a'];
            }
        ...
        for(I = len - 2; I >= 0; I--)
        {
            ...
            {
                if(S[I + 1] > ch)
                    after[I][ch - 'a'] = after[I + 1][ch - 'a'] + 1;
                else
                    after[I][ch - 'a'] = after[I + 1][ch - 'a'];
            }
        ...
        for(I = 0; I < len; I++)
        {
            for(char ch = 'a'; ch <= 'z'; ch++)
            {
                ...
                newY = unY - (before[I][c1] + after[I][c1]) + (before[I][c2] + after[I][c2]);
                ans = min(ans, X + newY);
            }
        }
