//  CS Academy_Round #80 - Digits Permutation.cpp
...
LL ToLongInt(string s) { LL r = 0; istringstream sin(s); sin >> r; return r; }//NOTES:ToInt(
...
int main()
{
	...
	///READ();
	///WRITE();
	int T, I, J, K, N, n, m, k, cnt = 0, len, b, x, y;
