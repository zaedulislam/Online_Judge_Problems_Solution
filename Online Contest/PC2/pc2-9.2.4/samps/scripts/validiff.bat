...
REM
REM
REM $HeadURL: http://pc2.ecs.csus.edu/repos/pc2v9/branches/PC2_RELEASE_9_2_x/samps/scripts/validiff.bat $
REM $Id: validiff.bat 1962 2009-11-25 03:42:12Z boudreat $
REM Directions
