...
rem $HeadURL: http://pc2.ecs.csus.edu/repos/pc2v9/branches/PC2_RELEASE_9_2_x/bin/pc2ver.bat $
...
:end
rem eof pc2ver.bat $Id: pc2ver.bat 1761 2009-02-14 21:02:24Z boudreat $
