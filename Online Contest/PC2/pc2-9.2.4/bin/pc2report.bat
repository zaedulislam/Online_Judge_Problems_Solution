...
rem $HeadURL: http://pc2.ecs.csus.edu/repos/pc2v9/branches/PC2_RELEASE_9_2_x/bin/pc2report.bat $
...
java -Xms64M -Xmx768M -cp %libdir%\pc2.jar;%mclbdir%\mclb.jar edu.csus.ecs.pc2.core.report.Reports %1 %2 %3 %4 %5 %6 %7 %8 %9

:end
rem eof pc2report.bat $Id: pc2report.bat 2100 2010-08-27 03:03:53Z laned $
