// Codeforces 776A - A Serial Killer.cpp
...
int main()
{
	...
	for(I = 1; I <= n; I++)
	{
		...
		if(S1 == ar[I].first)
			ar[I + 1] = (pss(S2, ar[I].second));

		else if(S1 == ar[I].second)
			ar[I + 1] = (pss(S2, ar[I].first));

		else if(S2 == ar[I].first)
			ar[I + 1] = (pss(S1, ar[I].second));

		else if(S2 == ar[I].second)
			ar[I + 1] = (pss(S1, ar[I].first));
