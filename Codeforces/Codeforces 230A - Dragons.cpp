...
int main()
{
	...
	int tcases, caseno = 1, n, I, J, K = 0, N, cnt = 0, len, p, q, var, st, dragon, x, y, flag = 0;
	...
	FOR(I, 0, dragon){
		...
		else if (x < strength[I - 1]){
			K = I;
			while (x < strength[K - 1]){
