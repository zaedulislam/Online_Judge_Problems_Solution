// Codeforces 962C - Make a Square.cpp
...
LL ToLL(string s) { LL r = 0; istringstream sin(s); sin >> r; return r; }//NOTES:ToInt(
...
void F(int pos, int len, int cnt, string str)
{
