// Codeforces 977E - Cyclic Component.cpp
...
bool visited[SIZE], hasCycle = false, flag = true;
int parent[SIZE], indegree[SIZE], src = -1, cnt = 0;
vector<int> G[SIZE], nodes;
...
int main()
{
	...
	///READ();
	///WRITE();
	int T, I, J, K, N, n, m, k, len, u, v, SZ, cc = 0;
