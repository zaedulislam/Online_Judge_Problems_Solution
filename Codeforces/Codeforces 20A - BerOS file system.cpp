// Codeforces 20A - BerOS file system.cpp
/*The character '/' (or some sequence of such characters) at the end of the path is required only in case of the path 
to the root directory, which can be represented as single character '/'.*/
#include <iostream>
#include <cstdio>
