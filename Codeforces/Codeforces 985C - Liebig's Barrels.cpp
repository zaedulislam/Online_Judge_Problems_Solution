// Codeforces 985C - Liebig's Barrels.cpp
...
int main()
{
	...
	///READ();
	///WRITE();
	int T, I, J, K, N, n, m, k, cnt = 0, len, validRange, l, extra;
	LL sum;
