// Codeforces 681C - Heap Operations.cpp
...
int main()
{
	...
	///READ();
	///WRITE();
	int T, I, J, K, N, n, m, k, cnt = 0, len, x;
    ...
    for(I = 0; I < n; I++)
    {
        ...
        else if(S == "removeMin")
        {
            ...
            {
                PQ.push(-1);
                operations.PB(psi("insert", 1));
            }

            PQ.pop();
            operations.PB(psi(S, 1000000002));
        ...
        else if(S == "getMin")
        {
            ...
            else
            {
                ...
                {
                    PQ.pop();
                    operations.PB(psi("removeMin", 1000000002));
    ...
    {
        S = operations[I].first;
        x = operations[I].second;
