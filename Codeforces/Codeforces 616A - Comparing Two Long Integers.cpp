// Codeforces 616A - Comparing Two Long Integers.cpp
#include <iostream>
#include <cstdio>
...
// fflush(stdout);
string S, T;
char a[SIZE], b[SIZE], s1[SIZE], s2[SIZE];
int ar[SIZE];
int M[1000][1000];
...
int main()
{
	...
	ULL tcases, caseno = 1, n, I, J, K, N, cnt = 0, len1, len2, flag, sum1 = 0, sum2 = 0;
