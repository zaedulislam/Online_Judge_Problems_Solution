// Codeforces 785B - Anton and Classes.cpp
...
int main()
{
	...
	for(I = 0; I < n; I++)
	{
		...
		c1[I].first = c[I].second;
		c1[I].second = c[I].first ;
	}
	...
	for(I = 0; I < m; I++)
	{
		...
		p1[I].first = p[I].second;
		p1[I].second = p[I].first ;
	}
	...
	x1 = MAX(x1, (p[m - 1].first - c[0].first));
	x2 = MAX(x2, (c1[n - 1].first - p1[0].first));
