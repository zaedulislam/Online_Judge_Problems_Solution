// Codeforces 653A - Bear and Three Balls.cpp
#include <iostream>
#include <cstdio>
...
int main()
{
	...
	int tcases, caseno = 1, I, J, K, N, n, m, cnt = 0, len, f, ball;
    ...
    f = 0;
    for(I = 1;  I < K - 1; I++){
        if((ar[I] - ar[I - 1] <= 2) && (ar[I + 1] - ar[I] <= 2) && (ar[I + 1] - ar[I - 1] <= 2))
            cnt++;
        else cnt = 0;
        if(cnt == 1){
            f = 1; break;
